          ...
          <div class="row g-0">
            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                alt="logo" class="img-fluid" style="border-radius: 1rem 0 0 1rem;" /> -->
                     <img src="https://www.logopeople.in/blog/wp-content/uploads/2013/01/government-of-india.jpg"
                alt="logo" class="img-fluid" style="border-radius: 1rem 0 0 1rem; width:200px;" />
                      
                    </span>
                  </div>

                  <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Enter Your Account Detail</h5>
