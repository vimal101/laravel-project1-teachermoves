    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bgsidebar" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                <a href="{{url('/admin-dashboard')}}" class="list-group-item list-group-item-action bg-transparent second-text active" target="_blank"><i
                        class="fas fa-tachometer-alt me-2" ></i>Manage Teacher</a>

                <a href="{{url('/school')}}" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                        class="fas fa-project-diagram me-2"></i>Manage School
                    </a>
                <a href="{{url('/show_complaint_rised')}}" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                        class="fa-solid fa-circle-exclamation"></i>Resolve Complaints</a>
